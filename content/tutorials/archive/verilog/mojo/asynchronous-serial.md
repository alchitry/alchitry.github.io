...
This is a more realistic example of using state machines than the state machine introduced in the [metastability and debouncing tutorial](@/tutorials/archive/verilog/mojo/metastability-and-debouncing.md).
