...
The project for this tutorial will be very similar to the [Creating a Project](@/tutorials/archive/verilog/mojo/creating-an-ise-project.md) tutorial with one difference. Instead of using the reset button to control the LED, we are going to hook up an external button to control the LED.
