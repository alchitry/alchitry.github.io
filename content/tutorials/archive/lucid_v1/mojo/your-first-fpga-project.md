...
Congratulations! You've finished your first tutorial on Lucid. When you're ready for more click here for the [Synchronous Logic Tutorial](@/tutorials/archive/lucid_v1/mojo/synchronous-logic.md).