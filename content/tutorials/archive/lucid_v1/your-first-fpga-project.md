...
aliases = ["tutorials/lucid_v1/your-first-fpga-project.md"]
+++
...
Back to our always block, the first two lines connect the input _rst_n_ to the input of the _reset_cond_ module. Modules
